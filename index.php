...
<div class="container text-center">    
  <h1 style=" font-family: 'Dancing Script', cursive;color:white  ; font-weight:bold;font-size:50px; padding:15px; position: relative; bottom: 390px; filter:drop-shadow(10px 2px 4px rgb(129, 94, 5)); letter-spacing:3px;">Welcome To Alpha Royal Hotel<br><br><p style="font-size:35px;"></p></h1><br>
  <div class="row">
	...
	<div class="col-sm-4" style="height: 500px;">
      <img style="width:300px;height:200px"src="image/rooms/<?php echo $r_res['image']; ?>"class="img-responsive thumbnail"alt="Image"id="img1"> <!--Id Is Img-->
